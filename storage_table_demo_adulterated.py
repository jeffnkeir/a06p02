...
resourcegroup_name = 'jnk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
storageaccount_name = 'jnk'+''.join(random.choice(string.ascii_lowercase + string.digits) for _ in range(6))
...
cars.year = '1952'
cars.color = 'scots'
cars.price = 'vocals/lyrics'
table_service.insert_entity('itemstable', cars)
print('Created entry for david...\n')
...
coffee.RowKey = '004'
coffee.brand = 'frenchmarket'
coffee.flavor = 'chickory'
coffee.size = 'toobig'
coffee.price = 'toomuch'
table_service.insert_entity('itemstable', coffee)
print('Created entry for a frenchmarket chickory coffee...\n')
time.sleep(1)
...
coffee.price = '0.99'
table_service.insert_entity('itemstable', coffee)
print('Created entry for folgers cup-o-mud...\n')
time.sleep(1)
